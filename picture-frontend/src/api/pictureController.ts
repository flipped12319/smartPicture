...
/** listPictureByPageWithCache POST /api/list/page/cache */
export async function listPictureByPageWithCacheUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePagePicture_>('/api/list/page/cache', {
    method: 'POST',
    headers: {
