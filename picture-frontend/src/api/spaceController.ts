...
/** getSpaceIdByUserId GET /api/space/getIdByUserId */
export async function getSpaceIdByUserIdUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getSpaceIdByUserIdUsingGETParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseLong_>('/api/space/getIdByUserId', {
    method: 'GET',
    params: {
      ...params,
    },
