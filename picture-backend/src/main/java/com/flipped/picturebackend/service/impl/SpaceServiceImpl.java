...
import com.flipped.picturebackend.mapper.SpaceMapper;
import com.flipped.picturebackend.model.dto.space.SpaceAddRequest;
...
import com.flipped.picturebackend.model.enums.SpaceLevelEnum;
...
public class SpaceServiceImpl extends ServiceImpl<SpaceMapper, Space> implements SpaceService {
    ...
    /**
     * 根据用户ID查询其所属的 spaceId
     * @param userId 用户主键
     * @return spaceId，若用户不存在则返回 null
     */
    @Override
